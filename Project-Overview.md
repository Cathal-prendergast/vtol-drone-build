...
- Configure ArduPilot
- Achieve reliable hover
- Transition successfully into forward flight
...
- Wing area ≈ 1.2m × 0.23583m ≈ 0.283 m²

This implies a moderate wing loading for a small UAV.
This provides:

- Stable low-speed handling during transition phases  
- Predictable stall behaviour near the 10 m/s design target  
- A balanced trade-off between endurance and manoeuvrability  

The aircraft design is optimised around controlled stability rather than high-speed performance or maximum lift efficiency.
